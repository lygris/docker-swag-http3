...
RUN mkdir -p /home/buildozer/aports/main/nginx/src && \
    ...
    wget -O /home/buildozer/aports/main/nginx/src/nginx-keyval-0.3.0.tar.gz https://github.com/nginxinc/nginx-keyval/archive/refs/tags/v0.3.0.tar.gz && \
    wget -O /home/buildozer/aports/main/nginx/src/nginx-log-zmq-1.0.0.tar.gz https://github.com/zeromq/nginx-log-zmq/archive/refs/tags/v1.0.0.tar.gz && \
    ...
    wget -O /home/buildozer/aports/main/nginx/src/ngx_upstream_jdomain-1.5.2.tar.gz https://github.com/GUI/nginx-upstream-jdomain/archive/refs/tags/v1.5.2.tar.gz && \
    ...
    wget -O /home/buildozer/aports/main/nginx/src/mod_zip-1.3.0.tar.gz https://github.com/evanmiller/mod_zip/archive/refs/tags/v1.3.0.tar.gz && \
    wget -O /home/buildozer/aports/main/nginx/src/zstd-nginx-module-0.1.1.tar.gz https://github.com/openresty/zstd-nginx-module/archive/refs/tags/v0.1.1.tar.gz && \
...
RUN tar -xvzf /home/buildozer/aports/main/nginx/src/njs-0.8.9.tar.gz -C /home/buildozer/aports/main/nginx/src && \
    ...
    tar -xvzf /home/buildozer/aports/main/nginx/src/ngx_brotli-1.0.0rc.tar.gz -C /home/buildozer/aports/main/nginx/src && \
